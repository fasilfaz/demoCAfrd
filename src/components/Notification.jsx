...
const getNotificationIcon = (type) => {
  switch (type) {
    ...
    case "mention":
      return (
        <div className="flex-shrink-0 flex items-center justify-center h-8 w-8 rounded-full bg-yellow-100">
          <svg
...
const Notification = ({ notification, onMarkAsRead }) => {
  return (
    <div
      ...
      } hover:bg-gray-50 rounded-lg transition-colors duration-150 ease-in-out`}
    >
